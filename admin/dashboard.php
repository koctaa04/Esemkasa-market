        ...
        <main>
            ...
            <div class="details-dash">
                <div class="recentorders">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $produk = mysqli_query($conn, "SELECT * FROM produk  limit 7");
                ...
                <div class="recentcustomers">
                    <div class="cardheader">
                        <h2>Recent Seller</h2>
                        <a href="seller.php" class="btn">View All</a>
                    </div>
                    <table>
                        <tbody>
                            <?php
                            $no = 1;
                            $seller = mysqli_query($conn, "SELECT * FROM `penjual` limit 5");
                            while ($Tseller = mysqli_fetch_array($seller)) {

                            ?>
                                <tr>
                                    <td width="60px">
                                        <div class="imgbox"><img src="../img/logo/<?= $Tseller['profil'] ?>"></div>
                                    </td>
                                    <td>
